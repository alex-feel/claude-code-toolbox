...
class TestRootGuardInstallClaude:
    ...
    def test_root_guard_error_message_content(self, capsys: pytest.CaptureFixture[str]) -> None:
        ...
        assert 'CLAUDE_CODE_TOOLBOX_ALLOW_ROOT' in combined, 'Error message should mention override variable'
    ...
    def test_root_guard_does_not_activate_on_windows(self) -> None:
        ...
        with (
            ...
            patch.dict('os.environ', {'CLAUDE_CODE_TOOLBOX_INSTALL_METHOD': 'native'}), contextlib.suppress(SystemExit),
        ):
            install_claude.main()
...
class TestRootGuardSetupEnvironment:
    ...
    def test_root_guard_error_message_content(self, capsys: pytest.CaptureFixture[str]) -> None:
        ...
        captured = capsys.readouterr()
        combined = captured.out + captured.err
        assert 'CLAUDE_CODE_TOOLBOX_ALLOW_ROOT' in combined, 'Should mention override variable'
        assert 'root' in combined.lower() or 'sudo' in combined.lower()
