...
#######################################################
# Claude Code Python Environment Setup for Linux
#
...
write_header() {
    echo -e "\n${BLUE}╔══════════════════════════════════════════════════════════════════════╗${NC}"
    echo -e "${BLUE}║                                                                      ║${NC}"
    echo -e "${BLUE}║       Claude Code Python Environment Setup for Linux                ║${NC}"
    echo -e "${BLUE}║                                                                      ║${NC}"
    echo -e "${BLUE}╚══════════════════════════════════════════════════════════════════════╝${NC}\n"
}
...
if [[ "$SKIP_INSTALL" != "true" ]]; then
    ...
    if curl -fsSL "$REPO_BASE_URL/scripts/linux/install-claude-linux.sh" | bash; then
...
if bash -c "$MCP_COMMAND" 2>/dev/null; then
...
echo -e "\n${YELLOW}💡 Tip: Add an alias to your shell config for quick access:${NC}"
