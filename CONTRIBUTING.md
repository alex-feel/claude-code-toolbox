...
- **DO NOT manually edit the `version` field in pyproject.toml or CITATION.cff** - automatically updated by Release Please
...
1. After merging PRs to main, Release Please automatically:
   - Creates/updates a release PR with:
     ...
     - Bumped version in pyproject.toml and CITATION.cff
